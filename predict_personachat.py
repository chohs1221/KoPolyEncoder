...
if __name__ == '__main__':
    ...
    if args.incorpus:
        tokenizer, model, candidate_text, candidate_embeddings = get_candidates_incorpus('./data/pickles/persona_train_100000.pickle', model_path, args, batch_size = 256, device=device)
    else:
        tokenizer, model, candidate_text, candidate_embeddings = get_candidates_designated('./data/responses_personachat.txt', model_path, args, device=device)
